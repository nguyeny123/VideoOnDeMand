    ...
    public class MockReadRepository : IReadRepository
    {
        ...
        List<Course> _courses = new List<Course> {
            new Course { Id = 1, InstructorId = 1,
                ...
                ImageUrl = "/images/laptop.jpg", Title = "C# For Beginners",
        ...
        {
            new UserCourse { UserId = "49790fc2-98bb-44d6-a0ce-951ab25d66e0",
                CourseId = 1 },
        ...
        List<Video> _videos = new List<Video>
        {
            ...
            new Video { Id = 5, ModuleId = 1, CourseId = 1, Position = 3,
                Title = "Video 5 Title", Description = "Video 5 Description: A very very long description.",
